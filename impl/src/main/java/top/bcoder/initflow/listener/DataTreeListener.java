...
public class DataTreeListener <T extends DataObject> implements AutoCloseable, ClusteredDataTreeChangeListener<T> {
	private static final Logger LOG = LoggerFactory.getLogger(DataTreeListener.class);
    protected DataBroker db;
    private static final ThreadFactory threadFactory = new ThreadFactoryBuilder()
        .setNameFormat("IIS-FlowListenerThread-%d").build();
    ...
    private ListenerRegistration<DataTreeListener<T>> listenerRegistration;

    public DataTreeListener(DataProcessor<T> dataProcessor,
