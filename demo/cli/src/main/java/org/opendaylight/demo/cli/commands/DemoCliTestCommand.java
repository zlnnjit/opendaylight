...
import org.opendaylight.demo.cli.api.DemoCliCommands;
...
public class DemoCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(DemoCliTestCommand.class);
    protected final DemoCliCommands service;

    public DemoCliTestCommand(final DemoCliCommands service) {
