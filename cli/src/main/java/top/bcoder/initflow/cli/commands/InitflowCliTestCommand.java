 ...
 */
package top.bcoder.initflow.cli.commands;
...
public class InitflowCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(InitflowCliTestCommand.class);
    protected final InitflowCliCommands service;

    public InitflowCliTestCommand(final InitflowCliCommands service) {
