 ...
 */
package org.opendaylight.topology.cli.commands;

import org.apache.karaf.shell.commands.Command;
import org.apache.karaf.shell.commands.Option;
import org.apache.karaf.shell.console.AbstractAction;
import org.opendaylight.topology.cli.api.TopologyCliCommands;
...
public class TopologyCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(TopologyCliTestCommand.class);
    protected final TopologyCliCommands service;

    public TopologyCliTestCommand(final TopologyCliCommands service) {
